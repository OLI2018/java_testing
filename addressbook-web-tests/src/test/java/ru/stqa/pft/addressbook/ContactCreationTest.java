...
public class ContactCreationTest {
  ...
  public void setUp() throws Exception {
    ...
    loginToPage("admin", "secret");

  }

  private void loginToPage(String login, String password) {
  ...
  public void testContactCreationTest() {
    addNew();
    personalInfo(new PersonalInfoData("Petr", "Petrovich", "Petrov", "Pupa", "QA Engineer", "Super Puper Company", "1234 Google St SE, London, CA, 98208"));
    phones(new PhonesData("123 456 78 99", "321 432 54 76 ", "456 431 66 66", "333 333 33 33"));
    emailsAndHomePage(new EmailsData("test@test.com", "lomn@google.com", "petrpetr@yahoo.com", "www.homepage.com"));
    secondaryContacts();
  }

  private void secondaryContacts() {
  ...
  private void emailsAndHomePage(EmailsData emailsData) {
  ...
  private void phones(PhonesData phonesData) {
  ...
  private void personalInfo(PersonalInfoData personalInfoData) {
