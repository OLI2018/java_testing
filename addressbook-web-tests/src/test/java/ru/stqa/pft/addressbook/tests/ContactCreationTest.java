...
public class ContactCreationTest extends TestBase {
  ...
  public void testContactCreationTest() {
    ...
    app.getContactHelper().primaryContacts(new ContactData("123 123 11 11", "456 456 56 56", "789 789 99 99", "369 369 69 69", "test@test.com", "protest@protest.com", "tester@tester.com", "www.tester.com"));
